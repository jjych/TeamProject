...
<html lang="en">
    ...
    <body id="page-top">
        ...
        <section class="page-section portfolio" id="portfolio">
            <div class="container">
                <!-- 헬스기구 문구 -->
                <h2 class="page-section-heading text-uppercase text-secondary mb-0">헬스기구</h2>
                <!-- 밑줄-->
                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-md-6 col-lg-4 mb-5">
                        <a href = "#">
                        <img class="img-fluid" src="resources/assets/HealthImg/BenchPress.PNG"  style="width:270px; height: 200px;"alt="" />
                        </a>   
                           <br><br>
                           <h4> 상품명 : 요가 써클링</h4>
                           <h5> 가격 : 8,000원</h5>
                    ...
                    <div class="col-md-6 col-lg-4 mb-5">
                        <a href = "#">
                        <img class="img-fluid" src="resources/assets/HealthImg/Dumbbell.PNG"  style="width:270px; height: 200px;"alt="" />
                        </a>   
                           <br><br>
                           <h4> 상품명 : 마사지 볼</h4>
                           <h5> 가격 : 11,000원</h5>
                    ...
                    <div class="col-md-6 col-lg-4 mb-5 mb-lg-0">
                        <a href = "#">
                        <img class="img-fluid" src="resources/assets/HealthImg/LatPullDown.PNG"  style="width:270px; height: 200px;"alt="" />
                        </a>   
                           <br><br>
                           <h4> 상품명 : 요가폼블러</h4>
                           <h5> 가격 : 1,370,000원</h5>
                    ...
                    <div class="col-md-6 col-lg-4 mb-5 mb-md-0">
                        <a href = "#">
                        <img class="img-fluid" src="resources/assets/HealthImg/RunningMachine.PNG"  style="width:270px; height: 200px;"alt="" />
                        </a>   
                           <br><br>
                           <h4> 상품명 : 요가메트</h4>
                           <h5> 가격 : 12,000원</h5>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <a href = "#">
                        <img class="img-fluid" src="resources/assets/HealthImg/Squat.PNG"  style="width:270px; height: 200px;"alt="" />
                        </a>   
                           <br><br>
                           <h4> 상품명 : 요가옷</h4>
                           <h5> 가격 : 13,000원</h5>
